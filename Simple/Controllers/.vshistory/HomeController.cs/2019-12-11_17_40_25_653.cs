...
namespace Simple.Controllers
{
	public class HomeController : Controller
	{
		...
		public async Task<IActionResult> IndexAsync(CancellationToken cancellationToken = default)
		{
			...
			Task<int> countTask = query.LongCountAsyncEF(cancellationToken);
			...
			;
			var totalCustomers = customerResult.First().Total;
			IEnumerable<Customer> customersData = customerResult.Select(c => c).ToList();
