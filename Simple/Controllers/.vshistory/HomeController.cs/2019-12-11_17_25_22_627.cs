...
namespace Simple.Controllers
{
	public class HomeController : Controller
	{
		...
		public async Task<IActionResult> IndexAsync(CancellationToken cancellationToken = default)
		{
			...
			var pagedQueryable = query.OrderBy(e => e.ProductId)
				.Skip(1).Take(4)
				.Select(e => new
				{
			...
			var page = await pagedQueryable.ToListAsync(cancellationToken);
			var total = await page.FirstOrDefault().TotalAsync;
